...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20231026091755_Created_Dettaglio6_Entity1ù")]
    partial class CreatedDettaglio6Entity1ù
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Dettagli.Dettaglio", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppDettagli", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.Ordini.ordine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.Prodotti.Prodotto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.Dettagli.Dettaglio", b =>
                {
                    b.HasOne("Acme.BookStore.Ordini.ordine", null)
                        .WithMany()
                        .HasForeignKey("OrdiniId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.BookStore.Prodotti.Prodotto", null)
                        .WithMany()
